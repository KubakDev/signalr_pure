// ignore_for_file: constant_identifier_names, non_constant_identifier_names, avoid_function_literals_in_foreach_calls, prefer_function_declarations_over_variables, avoid_returning_null_for_void
  ...
  group('# HttpConnection', () {
    ...
    test('# redirects to url when negotiate returns it with access token',
      ...
      await VerifyLogger.runAsync((logger) async {
        ...
        final options = HttpConnectionOptions(
          accessTokenBuilder: () async => 'firstSecret',
          httpClient: httpClient,
          logger: logger,
          transport: HttpTransportType.longPolling,
        );
